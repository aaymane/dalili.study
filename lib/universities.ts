...
export const UNIVERSITIES: Record<string, University> = {
  ...
  'universite-cote-azur': {
    slug: 'universite-cote-azur',
    name: "Université Côte d'Azur",
    city: 'Nice',
    region: "Provence-Alpes-Côte d'Azur",
    type: 'Université publique · Label IdEx',
    students: 28000,
    internationalStudents: 5600,
    tuitionLicence: 2895,
    tuitionMaster: 3941,
    popularPrograms: [
    ...
    costCrous: '200–420 €/mois',
    costPrivate: '600–900 €/mois',
    costTransport: '30 €/mois (Lignes d\'Azur)',
    costFood: '100–220 €/mois (RU à 1€)',
    monthlyBudgetMin: 750,
    monthlyBudgetMax: 1200,
    pros: [
      "Label d'excellence IdEx — reconnue mondialement en mathématiques et IA",
      "Sophia Antipolis à 20 min : 2 400 entreprises tech dont Google, IBM, Amadeus",
      "Aéroport Nice direct vers le Maghreb (Casablanca, Alger, Tunis)",
      "20% d'étudiants étrangers — campus très international",
      "Mer Méditerranée à 10 min, soleil toute l'année",
      "Partenariats INRIA, CNRS, Université de Monaco et universités italiennes",
    ],
    cons: [
      "Une des villes les plus chères de France hors Paris — logement à partir de 600 €",
      "Marché locatif très tendu toute l'année",
      "Moins d'industries lourdes qu'à Lyon ou Toulouse",
    ],
    avis: "L'UCA est notre recommandation n°1 pour les étudiants en informatique/IA et en sciences. Le label IdEx garantit un niveau de recherche mondial, et Sophia Antipolis à 20 min offre un accès direct à 40 000 emplois tech. Budget à prévoir : 750-1200€/mois minimum. Avis Dalili : 4/5.",
    websiteUrl: 'https://univ-cotedazur.fr',
  ...
  'universite-rennes-1': {
    slug: 'universite-rennes-1',
    name: 'Université de Rennes',
    city: 'Rennes',
    region: 'Bretagne',
    type: 'Université publique · Label Bienvenue en France ⭐⭐⭐',
    students: 33000,
    ...
    costPrivate: '430–620 €/mois',
    costTransport: '26 €/mois (STAR)',
    costFood: '80–190 €/mois (RU à 1€)',
    monthlyBudgetMin: 600,
    monthlyBudgetMax: 950,
    pros: [
      "Capitale française de la cybersécurité — IRISA, Orange Cyberdefense, Thales DIS sur campus",
      "Budget parmi les plus abordables des grandes universités françaises",
      "1h30 de Paris en TGV — proximité capitale sans le coût parisien",
      "French Tech Rennes très active — nombreuses startups et stages informatiques",
      "Ville 100% étudiante : 70 000 étudiants pour 220 000 habitants",
      "Label Bienvenue en France ⭐⭐⭐ — très bon accueil des étudiants étrangers",
    ],
    cons: [
      "Météo pluvieuse et grise — Bretagne oblige",
      "Moins d'industries lourdes que Lyon ou Toulouse",
      "Moins connue à l'international que Paris, Lyon ou Nice",
    ],
    avis: "Rennes est notre recommandation n°1 pour l'informatique, la cybersécurité et le droit avec un budget maîtrisé. Orange Cyberdefense et Thales DIS recrutent directement sur campus. Budget serré possible dès 600€/mois. Avis Dalili : 4/5.",
  ...
  'universite-grenoble-alpes': {
    ...
    costCrous: '180–380 €/mois',
    costPrivate: '450–650 €/mois',
    costTransport: '28 €/mois (TAG)',
    costFood: '90–200 €/mois (RU à 1€)',
    monthlyBudgetMin: 620,
    monthlyBudgetMax: 1000,
    pros: [
      "Campus scientifique unique en Europe : CEA, ILL (réacteur nucléaire), ESRF (synchrotron), CNRS",
      "18% d'étudiants étrangers — l'une des universités les plus internationales de France",
      "Alpes à 30 min — ski fortement réduit pour les étudiants UGA",
      "Schneider Electric, STMicroelectronics, Soitec — stages directs depuis le campus",
      "Label IdEx — excellence académique et recherche mondiale",
      "Budget plus accessible qu'à Lyon ou Paris pour une qualité comparable",
    ],
    cons: [
      "Hiver froid, peu ensoleillé et brumeux en cuvette alpine",
      "Ville perçue comme austère et moins festive que Lyon ou Bordeaux",
      "Éloignée de la mer (3h minimum)",
    ],
    avis: "Grenoble Alpes est notre recommandation absolue pour la physique, les nanosciences, l'énergie et l'ingénierie. Nulle part ailleurs en France vous n'accéderez à autant d'équipements scientifiques sur un seul campus (CEA, ILL, ESRF). Avis Dalili : 4,5/5.",
  ...
  'universite-clermont-auvergne': {
    slug: 'universite-clermont-auvergne',
    ...
    popularPrograms: [
      'Médecine et pharmacie',
      'Sciences et ingénierie (chimie, physique, mécanique)',
      'Droit et sciences politiques',
      'Informatique et mathématiques',
      'Chimie et matériaux (spécialité caoutchouc)',
      'STAPS (sport)',
    ],
    costCrous: '150–320 €/mois',
    costPrivate: '350–520 €/mois',
    costTransport: '22 €/mois (T2C)',
    costFood: '80–180 €/mois (RU à 1€)',
    monthlyBudgetMin: 500,
    monthlyBudgetMax: 800,
    pros: [
      "Budget le plus bas de France — chambre CROUS dès 150€, studio dès 350€",
      "Label IdEx — université d'excellence malgré sa taille modeste",
      "Michelin siège mondial : chaires de recherche et recrutement direct sur campus",
      "Limagrain (géant mondial des semences) également présent à Clermont",
      "Volcans et Géoparc UNESCO du Massif Central à 15 min",
      "Ville très sûre et studieuse, idéale pour se concentrer",
    ],
    cons: [
      "Moins connue à l'international — prestige CV moindre que Lyon ou Paris",
      "Réseau transport moins dense que les grandes métropoles",
      "Vie culturelle et nocturne limitée",
    ],
    avis: "L'UCA est notre recommandation absolue pour le budget ultra-serré. 500€/mois tout compris, c'est unique en France. Michelin présent sur campus = débouchés directs en mécanique, chimie et matériaux. Le label IdEx garantit un niveau académique supérieur à sa réputation. Avis Dalili : 3,5/5.",
    websiteUrl: 'https://www.uca.fr',
  ...
  'universite-bourgogne': {
    ...
    popularPrograms: [
      ...
      'Agronomie et sciences du vin (AgroSup Dijon)',
      'STAPS et sciences du sport',
    ],
    costCrous: '170–340 €/mois',
    costPrivate: '380–550 €/mois',
    costTransport: '24 €/mois (Divia)',
    costFood: '80–190 €/mois (RU à 1€)',
    monthlyBudgetMin: 550,
    monthlyBudgetMax: 850,
    pros: [
      "Droit viti-vinicole unique au monde — filière liée au terroir de Bourgogne",
      "AgroSup Dijon : référence mondiale en agronomie et sciences du vivant",
      "Budget très abordable — 2ème moins chère des universités françaises",
      "Centre historique de Dijon classé UNESCO — qualité de vie exceptionnelle",
      "1h35 de Paris en TGV",
      "Très bonne reconnaissance en droit, économie et sciences",
    ],
    cons: [
      "Moins connue à l'international que les grandes métropoles",
      "Moins d'offres de stage dans les secteurs tech/finance/luxe",
      "Hiver continental froid (gel possible décembre-février)",
    ],
    avis: "L'Université de Bourgogne est une pépite méconnue pour les étudiants en droit et agronomie. Son droit viti-vinicole est une spécialité mondiale unique. Budget parmi les plus bas de France et cadre de vie exceptionnel. Avis Dalili : 3,5/5.",
    websiteUrl: 'https://www.u-bourgogne.fr',
