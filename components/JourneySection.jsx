...
const STEPS = [
  ...
  },
  {
    ...
    Icon: ClipboardList,
    title: 'CAF',
    subtitle: "JUSQU'À 200€/MOIS SI ÉLIGIBLE",
    desc: "Depuis juillet 2026, l'APL n'est plus automatique pour les étudiants hors UE. On t'aide à vérifier ta situation et à ne pas perdre un jour d'aide si tu y as droit.",
    accent: '#EFB370',
